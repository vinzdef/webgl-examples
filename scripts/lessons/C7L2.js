...
import vert from '~/shaders/C7L2/point.vert'
import frag from '~/shaders/C7L2/point.frag'

export default class C7L2 extends BaseChapter {
  prepare(gl) {
    this.rotation = 0
  ...
  initModelMatrix() {
    ...
    this.modelMatrix.setRotate(this.rotation, 0, 0)
